...
const market_agent_controller_1 = require("../controllers/market_agent.controller");
const router = (0, express_1.Router)();
const marketAgentController = new market_agent_controller_1.MarketAgentController();
